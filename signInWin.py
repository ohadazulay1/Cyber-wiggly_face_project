...
class Ui_firstWindow(object):
    def __init__(self):
        self.c = Client.get_instance()
        self.username = UserNameClass.get_instance()
    ...
    def setupUi(self):
        ...
        self.firstWindow.showMaximized()
    ...
    def retranslateUi(self):
        ...
        self.firstWindow.setWindowTitle(_translate("firstWindow", "MainWindow"))
    ...
    def signUpButtonPressed(self):
        new_window = Ui_SignUp(self.firstWindow)
